...
public class AddPage extends HttpServlet { 
    ...
    /**
     * Processes requests for both HTTP <code>GET</code> and <code>POST</code> dfs
     * methods.
     *
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            //String valid2_tosolve="glpxxxxxxat-PFdCMrbWzhUAAHxrrWx2";

            // Invalid token (it was valid but it expired)
            String invalid="glpat-sPSssSGru1sgPG1scy-u";

            // Valid token (it will be revoked)
            String valid3_torevoke="glpat-EAs2CW15xtSo7yb5k2k3";
